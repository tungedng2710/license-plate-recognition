...
class Pipeline():
    ...
    def __init__(self,
        ...
        # Core properties
        self.video = video
        self.vehicle_model = YOLOv8(vehicle_weight, conf_thres=0.6, iou_thres=0.6)
        self.plate_model = YOLOv8(plate_weight, conf_thres=0.15, iou_thres=0.5)
    ...
    def run(self,
        ...
        while cap.isOpened():
            ...
            if ret:
                ...
                # Detect vehicles and Tracking
                vehicle_boxes, confss, vehicle_labels, vehicle_results = self.vehicle_model(frame)
